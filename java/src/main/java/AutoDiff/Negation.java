...
public class Negation extends Term
{
    ...
    */
    public Negation(Term arg) throws Exception {
        setArg(arg);
    }
...
//    }
    ...
    */
    ...
    public Term aggregateConstants() throws Exception {
        ...
        {
            return TermBuilder.Constant(-(getArg() instanceof Constant ? (Constant)getArg() : (Constant)null).getValue
                ());
        }
        else
        {
    ...
    public Term derivative(Variable v) throws Exception {
        return Term.multiply(TermBuilder.Constant(-1),this.getArg()).derivative(v);
    }
