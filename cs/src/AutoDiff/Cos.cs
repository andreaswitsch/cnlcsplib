...
namespace AutoDiff
{
    ...
    /// </summary>
    [Serializable]
    public class Cos : Term
    {
        /// <summary>
        /// Constructs a new instance of the <see cref="Cos"/> class.
        /// </summary>
		...
		public override Term AggregateConstants()
		{
			...
			if (Arg is Constant) {
				return Math.Cos ((Arg as Constant).Value);
			} else {
		...
		{
			return new Sin(this.Arg)*-this.Arg.Derivative(v);
		}
    }
}
