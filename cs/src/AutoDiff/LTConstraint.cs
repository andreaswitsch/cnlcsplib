...
namespace AutoDiff
{
    ...
    /// </summary>
    [Serializable]
    public class LTConstraint : Term
    {
        /// <summary>
        ...
        public LTConstraint(Term x, Term y, double steepness)
        {
            Left = x;
            Right = y;
			Steepness = steepness;
 		...
 		internal LTConstraint(Term x, Term y, double steepness, Term negatedForm) : this(x,y,steepness) {
		...
		public override Term Negate ()
		{
			if (this.NegatedForm == null) {
				this.NegatedForm = new LTEConstraint(Right,Left,Steepness,this);				
			}
